...
public class CactusScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //まずは一回鳴かせる
        audioSource.PlayOneShot(SabotenVoice);
    }
    ...
    void Update()
    {
        ...
        //Dieのアニメーションにいるとき
        if (destroyed == false && animStateInfo.fullPathHash == Animator.StringToHash("Base Layer.Die"))
        {
            //アニメーションの終了を感知
            if (animStateInfo.normalizedTime >= 1.0f)
            {
                ...
                GameObject deathBlow = GameObject.Find("Lift/Camera/Canvas/deathBlow");
                death = deathBlow.GetComponent<Deathblow>();
                death.Set_deathblow(10);
